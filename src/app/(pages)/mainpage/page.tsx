  ...
  return (
    <div className='mainpage-background min-h-screen w-full'>
      ...
      <main className='flex flex-col'>
        <div className='w-full h-[530px] mt-[121px] bg-[#44BDF5] bg-[url("/img/mainpage/mainpage-logo.png")]  bg-cover bg-center bg-no-repeat'></div>
        ...
        <div className='flex flex-col items-center gap-[22px] mt-[57px] mb-[87px]'>
          ...
          <Button href='/booth'>공연 정보 보러가기</Button>
        </div>
      </main>
